    ...
    <div className={classes.dashboadright}>
      ...
      <div className={classes.listcolurm}>
        <div className={classes.listdevice}>
          <div className={classes.listdeviceleft}>
            <img
              src={pencentorange}
              alt="pencentorange"
              className={classes.pencentorange}
            ></img>
          ...
          <div className={classes.listdeviceright}>
            <div className={classes.listdevicertop}>
              <div className={classes.rowleft} style={{ color: "orange" }}>
                .
              </div>
            ...
            <div className={classes.listdevicertop}>
              <div className={classes.rowleft} style={{ color: "black" }}>
                .
              </div>
        ...
        <div className={classes.listdevice}>
          <div className={classes.listdeviceleft}>
            ...
            <div className={classes.listdevicemiddle}>
              ...
              <div className={classes.listdevicebottom}>
                ...
                ></img>
                <p
                  className={classes.listtitlebottom}
                  style={{ color: "blue" }}
                >
                  Dịch vụ
                </p>
          ...
          <div className={classes.listdeviceright}>
            <div className={classes.listdevicertop}>
              <div className={classes.rowleft} style={{ color: "blue" }}>
                .
              </div>
              <div className={classes.rowmiddle}>Đang hoạt động</div>
        ...
        <div className={classes.listdevice}>
          <div className={classes.listdeviceleft}>
            <img
              src={pencentgreen}
              alt="pencentgreen"
              className={classes.pencentgreen}
            ></img>
            <div className={classes.listdevicemiddle}>
              <p className={classes.number}>4.221</p>
              <div className={classes.listdevicebottom}>
          ...
          <div className={classes.listdeviceright}>
            <div className={classes.listdevicertop}>
              <div className={classes.rowleft} style={{ color: "green" }}>
                .
              </div>
            ...
            <div className={classes.listdevicertop}>
              <div className={classes.rowleft} style={{ color: "pink" }}>
                .
              </div>
            ...
            <div className={classes.listdevicertop}>
              <div className={classes.rowleft} style={{ color: "#F178B6" }}>
                .
              </div>
