  ...
  return (
    <div className={classes.dashboadlist}>
      <div className={classes.dashboadmiddle}>
        <div className={classes.dashboadtitle}>Dashboard</div>
        <div className={classes.levelchart}>Biểu đồ cấp số</div>
