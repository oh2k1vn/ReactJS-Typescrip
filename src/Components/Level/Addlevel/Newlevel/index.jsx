    ...
    <div className={classes.level}>
      <div className={classes.levelinfo}>
        <div className={classes.levelinfolist}>
          ...
          <p className={classes.leveltitle}>Danh sách cấp số</p>
          <img
            src={Levelgoto}
            alt="levelgoto"
            className={classes.levelgoto}
          ></img>
          <p className={classes.levellist}>Cấp số mới</p>
        </div>
                ...
                {isShow && (
                  <div className={classes.modal}>
                    <div className={classes.modal__item}>
                      <Link to="/level/">
                        <div className={classes.modal__item_close}>&times;</div>
                      </Link>
                      <div className={classes.modal__item_title}>
                        Số thứ tự được cấp
                      </div>
                      <div className={classes.modal__item_number}>2001201</div>
                      <div className={classes.modal__item_des}>
                        DV: Khám răng hàm mặt <span>(tại quầy số 1)</span>
                      </div>
                      <div className={classes.modal__item_footer}>
                        s
