    ...
    <div className={classes.detail}>
      <div className={classes.info}>
        <div className={classes.infolist}>
          ...
          <p className={classes.title}>Danh sách cấp số</p>
          <img
            src={Levelgoto}
            alt="levelgoto"
            className={classes.levelgoto}
          ></img>
          <p className={classes.detaillist}>Chi tiết</p>
        </div>
      ...
      <div className={classes.container}>
        <div className={classes.listtitle}>Quản lý cấp số</div>
        <div className={classes.newitem}>
          <div className={classes.informationlevel}>Thông tin cấp số</div>
          ...
          <div className={classes.listitem}>
            ...
            <div className={classes.source}>
              ...
              {dataNumberLevel.status == "Bỏ qua" && <ServiceUnactivePoint />}
            </div>
