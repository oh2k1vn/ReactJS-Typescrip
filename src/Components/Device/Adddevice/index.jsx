        ...
        <div className={classes.account}>
          <div className={classes.accountinfo}>
            <div className={classes.accountinfolist}>
              <p className={classes.accounttitle}>Thiết bị</p>
              <img
                src={Levelgoto}
                alt="levelgoto"
              ...
              <p className={classes.accounttitle}>Danh sách thiết bị</p>
              <img
                src={Levelgoto}
                alt="levelgoto"
                className={classes.levelgoto}
              ></img>
              <p className={classes.accountlist}>Thêm thiết bị</p>
            </div>
              ...
              <div className={classes.listitem}>
                ...
                <div className={classes.listinformation}>
                  ...
                  <div className={classes.accountname}>
                    ...
                    <input
                      className={classes.titlecontnet1}
                      type="text"
                      name=""
                      placeholder="Nhập mật khẩu"
                    />
