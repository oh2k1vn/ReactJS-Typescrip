...
function Updatedevice() {
  const optionsdevice = ["Chọn loại thiết bị", "Kiosk ", "Display counter"];
  const sumitdevice = (e) => {
    console.log(e.value);
  };
        ...
        <div className={classes.update}>
          <div className={classes.updateinfo}>
            <div className={classes.updateinfolist}>
              <p className={classes.updatetitle}>Thiết bị</p>
              <img
                src={Levelgoto}
                alt="levelgoto"
              ...
              <p className={classes.updatetitle}>Danh sách thiết bị</p>
              <img
                src={Levelgoto}
                alt="levelgoto"
                className={classes.levelgoto}
              ></img>
              <p className={classes.updatelist}>Thêm thiết bị</p>
            </div>
          ...
          <div className={classes.updatecontainer}>
            <div className={classes.updatelisttitle}>Quản lý tài khoản</div>
              ...
              <div className={classes.listitem}>
                ...
                <div className={classes.listinformation}>
                  <div className={classes.updatename}>
                    <p className={classes.updateid}>
                      Mã thiết bị:
                      <img
                        src={star}
                        alt="star"
                        className={classes.starid}
                      ></img>
                    </p>
                  ...
                  <div className={classes.updatename}>
                    ...
                    <div className={classes.list}>
                      ...
                      <div className={classes.item}>
                        <p className={classes.updatetitle__item}>Khám hô hấp</p>
                        <img
                          src={delefi}
                          alt="star"
                          className={classes.delefi}
