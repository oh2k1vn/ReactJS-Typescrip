        ...
        <div className={classes.detail}>
          <div className={classes.info}>
            <div className={classes.infolist}>
              <p className={classes.title}>Thiết bị</p>
              ...
              <p className={classes.title}>Danh sách thiết bị</p>
              <img
                src={Levelgoto}
                alt="levelgoto"
                className={classes.levelgoto}
              ></img>
              <p className={classes.detaillist}>Chi tiết thiết bị</p>
            </div>
          ...
          <div className={classes.container}>
            <div className={classes.listtitle}>Quản lý thiết bị</div>
            <div className={classes.newitem}>
              <div className={classes.informationlevel}>Thông tin thiết bị</div>
              <div className={classes.listitem}>
                ...
                <div className={classes.source}>Linhkyo011</div>
