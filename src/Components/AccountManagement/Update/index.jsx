...
function Update() {
  const optionsaccount = ["Chọn vai trò", "kế toán ", "Quản lý ", "Admin "];
    ...
    <div className={classes.account}>
      <div className={classes.accountinfo}>
        <div className={classes.accountinfolist}>
          <p className={classes.accounttitle}>Cài đặt hệ thống</p>
          <img
            src={Levelgoto}
            alt="levelgoto"
          ...
          <p className={classes.accounttitle}>Quản lý tài khoản</p>
          <img
            src={Levelgoto}
            alt="levelgoto"
            className={classes.levelgoto}
          ></img>
          <p className={classes.accountlist}>Cập nhật tài khoản</p>
        </div>
      ...
      <div className={classes.accountcontainer}>
        <div className={classes.accountlisttitle}>Quản lý tài khoản</div>
          ...
          <div className={classes.listitem}>
            ...
            <div className={classes.listinformation}>
              <div className={classes.accountname}>
                ...
                <input
                  className={classes.titlecontnet}
                  type="text"
                  name=""
              ...
              <div className={classes.accountname}>
                ...
                <img
                  src={eyeopen}
                  alt="star"
                  className={classes.eyeopennewpass}
                ></img>
              </div>
              <div className={classes.accountname}>
                <p className={classes.accountid}>
        ...
        <div className={classes.userbutton}>
          <Link to="/dashboard/AccountManagement">
            <button className={classes.cannel}>
              <a href="" className={classes.canneltitle}>
                Hủy bỏ{" "}
              </a>
            </button>
          </Link>
          <button className={classes.more}>
            <a href="" className={classes.moretitle}>
              Thêm{" "}
            </a>
          </button>
        </div>
