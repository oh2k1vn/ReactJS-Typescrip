...
function Bellactive() {
  ...
  return (
    <div className={classes.bellactive}>
      <p onMouseEnter={() => setIsShow(true)}>
        {" "}
        <img
          src={isShow ? bellActive : bell}
          ali="bell"
      ...
      {isShow && (
        <div className={classes.notify} onMouseLeave={() => setIsShow(false)}>
          ...
          <div className={classes.notifylist}>
            <div className={classes.notifylink}>
              <a href="#">
                <p className={classes.notifyname}>
                  Người dùng: Nguyễn Thị Thùy Dung
                </p>
                <p className={classes.notifytime}>
