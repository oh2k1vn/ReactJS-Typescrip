    ...
    <div className={classes.service}>
      <div className={classes.serviceinfo}>
        <div className={classes.serviceinfolist}>
          <p className={classes.servicetitle}>Dịch vụ</p>
          <img
            src={levelgoto}
            alt="levelgoto"
            className={classes.servicegoto}
          ></img>

          <p className={classes.servicelist}>Danh sách dịch vụ</p>
        </div>
      ...
      <div className={classes.servicecontainer}>
        <div className={classes.servicelisttitle}>Quản lý dịch vụ</div>
        ...
        <div className={classes.tablelistitem}>
          <div className={classes.servicetable}>
            ...
            <div className={classes.serviceitemname} style={{ width: "253px" }}>
              <p className={classes.serviceitemnametitle}>
                {" "}
          ...
          {dataServiceTable.map((item: any, index: any) => (
            <div className={classes.servicetablelist} key={index}>
              <div
                className={classes.serviceitemname}
                style={{ width: "150px" }}
              >
