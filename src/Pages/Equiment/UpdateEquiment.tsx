    ...
    <div className="UpdateEquiment">
      <div className="Equiment_header">
        <div className="Equiment_header_left">
          ...
          <p style={{ color: "#FF7506" }}>Cập nhật thiết bị</p>
        </div>
      ...
      <div className="UpdateEquiment_body">
        <p className="UpdateEquiment_body_p">Quản lý thiết bị</p>
        <div className="UpdateEquiment_body_content">
          <p>Thông tin thiết bị</p>
          {lists.map((item, index) => {
            return (
              <div key={index}>
                <div className="UpdateEquiment_body_content_layout">
                  <div className="UpdateEquiment_body_content_layout_items">
                    <label>Mã thiết bị: *</label>
                    <input type="text" name="" id="" placeholder={item.MTB} />
                    <label>Tên thiết bị: *</label>
                    <input type="text" name="" id="" placeholder={item.Name} />
                    <label>Địa chỉ IP: *</label>
                    <input type="text" name="" id="" placeholder={item.IP} />
                  </div>
                  <div className="UpdateEquiment_body_content_layout_items">
                    ...
                    <input type="text" name="" id="" placeholder={item.login} />
                    <label>Mật khẩu: *</label>
                    <input type="text" name="" id="" placeholder={item.pass} />
                  </div>
                </div>
                <form>
      ...
      <div className="UpdateEquiment_btn">
        <Link to="/admin/Equiment">
          <button className="UpdateEquiment_btn_active">Hủy bỏ</button>
        </Link>
